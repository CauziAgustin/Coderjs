const baseDeDatos = [
  ...
  {
    id: 18,
    nombre: "1 Unidad Palta",
    precio: 150,
    imagen: "verduras/Palta.jpg",
  },
  {
    id: 19,
    nombre: "1 Atado Rucula",
    precio: 100,
    imagen: "verduras/Rucula.jpg",
  },
  {
    id: 20,
    nombre: "1 Atado Acelga",
    precio: 100,
    imagen: "verduras/Acelga.jpg",
  },
  {
    id: 21,
    nombre: "1 Atado Espinaca",
    precio: 90,
...
function renderizarProductos() {
  baseDeDatos.forEach((info) => {
    ...
    miNodoBoton.classList.add("btn", "btn-primary", "d-flex","position-relative","top-25", "end-25");
